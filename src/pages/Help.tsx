...
const faqs = [
  ...
  },
  {
    ...
    answer: "A validação costuma ocorrer em até 48 horas úteis. Você pode acompanhar o status em “Histórico”.",
  },
  {
  ...
  },
  {
    ...
    answer: "No momento, os pontos são pessoais e intransferíveis. Estamos trabalhando em novas opções para o futuro.",
  },
];
    ...
    <AppLayout title="Ajuda e suporte" showBack>
      <div className="container px-4 py-6 space-y-6">
        <section className="bg-card border border-border/50 rounded-2xl shadow-soft p-6">
          <h2 className="font-display font-semibold text-lg text-foreground mb-4">Perguntas frequentes</h2>
        ...
        <section className="bg-card border border-border/50 rounded-2xl shadow-soft p-6">
          <h2 className="font-display font-semibold text-lg text-foreground mb-4">Canais de contato</h2>
          <div className="space-y-4">
            {contactChannels.map((channel) => {
              const Icon = channel.icon;
              return (
                <div key={channel.title} className="flex items-start gap-3 rounded-xl border border-border/50 p-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-foreground mt-1">{channel.detail}</p>
                  </div>
                </div>
              );
            })}
